...
await prisma.user.createMany({
  data: [
    { firstname: "Alice", lastname: "Oclock", email: "alice@oclock.io", password: "$argon2id$v=19$m=65536,t=3,p=4$DXOFdkk1gmX5l0FogtI3fA$6rks8DLL/0Bcrddfj2E0DPlt3RunF2vObpLVfh8WG3U", role: "admin" }, // "password"
